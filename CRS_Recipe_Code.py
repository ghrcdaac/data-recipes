...
#        the measured CRS radar reflectivity and Doppler velocity 
#        
...
#        to plot the data using this data recipe. If the code produces a memory error, try plotting 
...
from CRS_Recipe_Functions_Edit import CRSsubset_goesrplt, CRSsubset, plot_CRS2D, SAVEsubset, select_time_iphex, select_flight_goesrplt, CRSsubset_impacts
from CRS_Recipe_Functions_Edit import select_campaign, select_flight_olympex, select_flight_iphex, select_time_olympex, select_flight_impacts, select_time_impacts
